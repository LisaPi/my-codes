...
class SimpleSwitch14(app_manager.RyuApp):
    ...
    def add_flow(self, datapath, priority, match, actions):
        ...
        bucket_output_3 = [datapath.ofproto_parser.OFPActionOutput(3, 0)]
        bucket_3 = self.bucket_v12(datapath, action=bucket_output_3)
        buckets.extend(bucket_3)
        bucket_output_1 = [datapath.ofproto_parser.OFPActionOutput(1, 0)]
        bucket_1 = self.bucket_v12(datapath, action=bucket_output_1)
        buckets.extend(bucket_1)
        
        self.group_v12(datapath, command=0, type_=datapath.ofproto.OFPGT_SELECT	, groupid=1, buckets=buckets)
    ...
    def bucket_v12(self, datapath, len_=0, weight=1, watch_port=0xffffffff, watch_group=0xffffffff,action=[]):
