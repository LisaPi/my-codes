...
class SimpleSwitch14(app_manager.RyuApp):
    ...
    def switch_features_handler(self, ev):
        ...
        self.add_flow(datapath, ofproto.OFPFC_ADD, 0, match, actions)
    ...
    def _packet_in_handler(self, ev):
        ...
        if src == '00:00:00:00:03:e9':
            print("##############")
            self.add_flow(datapath, ofproto.OFPFC_DELETE, 1, match, actions)
            #time.sleep(10)
        elif src == '00:00:00:00:03:e8':
            print("bbbbbbbbbb")
            self.add_flow(datapath, ofproto.OFPFC_ADD, 1, match, actions)
            #time.sleep(10)
        else:
            #print("aaaaaaaaaa")
            self.add_flow(datapath, ofproto.OFPFC_ADD, 1, match, actions) 
