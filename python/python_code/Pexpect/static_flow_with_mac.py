...
# Add a  static flow with matching field mac_address to the bridge
child.sendline('./ctrlr-vsctl -- add Flow_Table table0 static_flows @sf2 -- --id=@sf2 create Static_Flow name=sf2 match:{in_port=1,eth_type=0x0800,eth_dst=22:22:22:22:22:22} actions:output=2')
child.expect('ctrlr-vsctl')
print child.before
