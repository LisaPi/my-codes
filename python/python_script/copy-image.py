...
def copy_image(sDr=None,sRevision=None,branch_name=None,model=None):
    ...
    for model_name in model:  
        ...
        if model_name in ['as5712_54x', 'niagara2632xl','niagara2948_6xl','dcs7032q28','HP6712','HP5712','s4048','as7712_32x','as6712_32x']:
            platform = 'x86'
        ...
        commands = [
                    ...
                    'exec md5sum picos-%s-%s-%s.tar.gz > picos-%s-%s-%s.tar.gz.md5' % (branch_name,image_model_name[model_name],sRevision,branch_name,image_model_name[model_name],sRevision)]
            
        sendExpect(child=child, commands=commands,exp_prompt=prompt)    

#if __name__ == "__main__":
#    copy_image(sDr=2.7,sRevision=22731,branch_name=1.1,model=['3290','3295'])   
