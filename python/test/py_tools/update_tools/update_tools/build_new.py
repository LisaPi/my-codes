...
Usage = """
Created on 2015-06-2
@author: lisapi
@name: buildimage.py

The script is used to build images for pica8,
supporting branches, 1.1  2.6 verizon 2.6B
supporting models, 3290 3295 3297 3922 3924 3930 3780 5401 es4654bf as6701_32x as5712_54x niagara2632xl arctica4804i niagara2948_6xl
...
SMTPSVR = '10.10.50.11'
branch_id = ['1.1','2.6','verizon','2.6B']
model_type = ['3290', '3295', '3297', '3920', '3922', '3924', '3930', '3780', '5401', '5101', 'es4654bf', 'as6701_32x', 'as5712_54x', 'niagara2632xl', 'arctica4804i']
...
for branch in branch_id:
    ...
    for model in model_type:
        if model in ['as5712_54x', 'niagara2632xl', 'niagara2948_6xl']:
            ...
            pica_config_name[branch][model] = './configure --prefix=%s/%s/%s/%s/rootfs-debian/%s \
                                        ...
                                        ' % (sDirs, hTmp, oDir, box_name_map[model], pica_xorp_map[branch], hType, sNoDug, sOpt, model, sDirs, sBcm, box_map[model], sDirs, hTmp, sLib)     
...
for branch in branch_id:
    ...
    for model in model_type:
        if model in ['as5712_54x', 'es4654bf', 'as6701_32x', 'niagara2632xl', 'niagara2948_6xl']:
...
###### Pica build 
def execute_pica_make(server_ip=None, branch_name=None, 
...
def execute_os_make(server_ip=None, branch_name=None, 
    ...
    if model_name not in ['as5712_54x', 'niagara2632xl','niagara2948_6xl']:
        commands = [
                'export ARCH=powerpc',
                ]
        execute_send_expect(child=child, commands=commands) 
...
def execute_main(server_ip=None, svn_type=None, branch_name=None, 
    ...
    if model_name in ["niagara2948_6xl"] and server_ip not in ["10.10.50.22"]:
        print 'platform of niagara2948_6xl image can only be built at 10.10.50.22!'
        sys.exit()        
