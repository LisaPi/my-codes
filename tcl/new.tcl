...
puts "222222222222 $sPro"
        	while 1 {
            	expect {
                	-re "Attached SCSI disk|Attached SCSI removable disk" {
                    	send "\r"
                    	break
                	}
            	}
		...
		} elseif {$sPro == "3922" || $sPro == "3930" || $sPro == "3296" || $sPro == "3924" || $sPro == "6700" || $sPro == "4654" || $sPro == "3297" } {
            while 1 {
                expect {
                    "#" {
