...
proc GetInstallerImage {sIp sPo sIm {sVer 0}} {
    ...
    #onie foramt  mapping  
    set onie_name [dict create  "3922" "accton_as5610_52x" \
                                 "3924" "accton_as5600_52x" \
                                 "4654" "accton_as4600_54t" \
                                 "6701" "accton_as6701_32x" \
                                 "461054" "accton_as4610" \
                                 "461030" "accton_as4610" \
                                 "4804" "penguin_arctica4804i" ]
    
    
    #onie platform foramt  mapping 
    set onie_format  [dict create    "3922" "powerpc" \
                                  "3924" "powerpc" \
                                  "4654" "powerpc" \
                                  "6701" "powerpc" \
                                  "461030" "arm" \
    ...
    #box dir mapping  
    set dir_name [dict create      "3922" "3922" \
                                    "3924" "as5600_52x" \
                                    "4654" "as4600_54t" \
                                    "6701" "as6701_32x" \
                                    "461030" "as4610" \
...
proc dbPort {sPort iPort sPro iPdu sPco} {
    ...
    regexp "(\[0-9a-z]+)-\[ ]\\\[--]\[ ]+(\[0-9a-z]+)_[set sPort]_i(\[0-9]+)_\[0-9]-\[0-9]+_c(\[0-9]+)" $sDbPort sTmp iPorts sPros sIps sPcos
...
######Update image for Powerpc via ONIE 
proc sUpdate_PowerPc  {sPort sIp sIm sPro iPort iPdu sPco sApp}  {
...
if {$sPort == "" || $sIp == "" || $sApp == ""} {
	...
	puts "********iPort is $iPort; sPro is $sPro; iPdu is $iPdu; sPco is $sPco********"
       if {[lsearch "6701 461054 461030 4654 3924" $sPro] == -1} {
           puts  "***$sPro does not support this onie function,so exits this update script***"
           exit   
       }
	set subject $sVer
	...
	if {$result == 1} {
       ...
       sUpdate_PowerPc   $sPort $sIp $sIm $sPro $iPort $iPdu $sPco $sApp
}
